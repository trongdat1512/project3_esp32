...
// Wifi 
const char* ssid = "netis_005FB7";
const char* password = "password";

// Server
const char *post_url = "http://192.168.0.10/ESP32/camera_upload.php";
const char *post_url_json = "http://192.168.0.10/ESP32/test/test.json";
